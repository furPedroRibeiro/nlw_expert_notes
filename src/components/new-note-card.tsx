              ...
              <form className='flex-1 flex flex-col'>
                <div className='flex flex-1 flex-col gap-3 p-5'>
                  ...
                  {shouldShowOnBoarding ? (
                    <p className="text-sm leading-6 text-slate-400">  
                      Começe <button type="button" className='font-medium text-lime-400 hover:underline' onClick={handleStartRecording}>gravando uma nota</button> em áudio ou se preferir <button type="button" onClick={handleStartEditor} className='font-medium text-lime-400 hover:underline'>utilize apenas texto</button>  
                    </p>
                  ) : (
                    <textarea 
                      autoFocus
                ...
                {isRecording ? (
                  ...
                  <button 
                    ...
                    className='w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:underline'
                  >
                    Salvar nota
                  </button>
                )}
